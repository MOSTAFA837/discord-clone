...
export const MembersModal = () => {
  ...
  const { open, isOpen, close, type, data } = useModal();
              ...
              {server.profileId !== member.profileId &&
                loadingId !== member.id && (
                  <div className="ml-auto">
                    <DropdownMenu>
                      <DropdownMenuTrigger>
                        <MoreVertical className="h-4 w-4 text-zinc-700 dark:text-zinc-100" />
                      </DropdownMenuTrigger>
                      ...
                      >
                        <DropdownMenuSub>
                          ...
                          <DropdownMenuPortal>
                            <DropdownMenuSubContent className=" bg-white dark:bg-black border-0">
                              <DropdownMenuItem
                        ...
                        <DropdownMenuSeparator className="bg-[#d4d4d4] dark:bg-[#464646]" />
